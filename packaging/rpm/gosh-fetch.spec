...
for HTTP, HTTPS, and BitTorrent downloads. Built with Qt 6 / Qt Quick for
a modern cross-desktop experience.

%prep
%autosetup

%install
install -Dm755 target/release/gosh-fetch-qt %{buildroot}%{_bindir}/gosh-fetch-qt
install -Dm644 crates/gosh-fetch-qt/qml/Main.qml %{buildroot}%{_datadir}/gosh-fetch/qml/Main.qml
...
%files
%license LICENSE
%{_bindir}/gosh-fetch-qt
%{_datadir}/gosh-fetch/qml/Main.qml
